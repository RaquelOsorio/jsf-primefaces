...
@Stateless
public class DetalleVentaRegistration {
    ...
    @Inject
    private Event<DetalleVenta> compra_detEventSrc;


    public void register(DetalleVenta producto) throws Exception {
        log.info("Registering " + producto.getProducto());//poner get producto
        em.persist(producto);
        compra_detEventSrc.fire(producto);
    }
    public void modificar(DetalleVenta detalle) throws Exception {
        log.info("Registering " + detalle.getId());
        em.merge(detalle);
        compra_detEventSrc.fire(detalle);
    }
    public void remover(DetalleVenta detalle) throws Exception {
