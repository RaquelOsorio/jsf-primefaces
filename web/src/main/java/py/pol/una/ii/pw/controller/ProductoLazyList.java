...
public class ProductoLazyList extends LazyDataModel<Producto>{
    ...
    {
        return ProductoLazyList.filtrado;
    }
    
    public void setFiltrado(Map<String,Object> fil)
    {
    	ProductoLazyList.filtrado = fil;
    }
...
//        String requestString = "http://localhost:8080/SistemaCompraVenta/csvProducto"; 
//        String nombre=(String) filtros.get("nombre");
//		System.out.println(nombre);
//		String cant=(String) filtros.get("cantidad");
//		System.out.println(cant);
//		String precioUnitario=(String) filtros.get("precioUnitario");
//		System.out.println(precioUnitario);
//                String descripcion=(String) filtros.get("descripcion");
//		System.out.println(descripcion);
//                String proveedor=(String) filtros.get("proveedor");
//		System.out.println(proveedor);
//		
//		if(nombre!=null || cant!=null || precioUnitario!= null 
//                        || descripcion!= null || proveedor!= null)
//			requestString+="?";
//		if (nombre !=null) {
...
//                       if( descripcion!= null || proveedor!= null)
//				requestString+="&";
//                }
//                
//		if (descripcion!= null) {
//			requestString+="descripcion="+descripcion;
//                       if(proveedor!= null)
//				requestString+="&";
//                }
//                
...
//    }
    ...
    public List<Producto> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters){
        ...
        try {
           request = new ClientRequest("http://localhost:8080/EjbJaxRS-web/rest/productos/filtrarCantidad/" + stringFiltros);
           request.accept("application/json");
           ...
           Logger.getLogger(ProductoLazyList.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            request = new ClientRequest("http://localhost:8080/EjbJaxRS-web/rest/productos/filtrar/" + stringFiltros);
            request.accept("application/json");
            response = request.get(String.class);
            br = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(response.getEntity().getBytes())));
            output = br.readLine();
